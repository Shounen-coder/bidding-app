    ...
    <div className="max-w-[1700px] mx-auto px-12 sm:px-16 lg:px-20 py-12">
      <div className="flex flex-col xl:flex-row gap-12">
        ...
        <div className="flex-1">
          ...
          {/* NEW: Page Navigation - Added between auction grid and load more button */}
          {auctions.length > 0 && (
            <div className="flex flex-col lg:flex-row items-center justify-between mt-12 mb-8 gap-6 bg-white rounded-2xl p-8 shadow-xl border border-gray-200">
              {/* Previous Button */}
              <button
                onClick={() => {
                ...
                className={`flex items-center px-6 py-3 text-sm font-semibold rounded-xl border-2 transition-all duration-300 ${
                  pagination.offset === 0 || isLoading
                    ...
                    : 'bg-gradient-to-r from-teal-50 to-cyan-50 text-teal-700 border-teal-200 hover:from-teal-100 hover:to-cyan-100 hover:border-teal-300 transform hover:scale-105'
                }`}
              >
                        ...
                        <button
                          ...
                          className={`px-4 py-2 text-sm font-semibold rounded-lg border-2 transition-all duration-300 ${
                            i === currentPage
                              ...
                              : 'bg-white text-teal-700 border-teal-200 hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 hover:border-teal-300'
                          }`}
                        >
                          {i}
                        </button>
          ...
          {/* Load More Button - Updated to use fetchMoreAuctions */}
          {/* {!isLoading && auctions.length > 0 && pagination.hasMore && (
...
//       <div className="max-w-[2000px] mx-auto px-6 sm:px-8 lg:px-12 py-20 relative z-10">
//         <div className="text-center">
...
//     {/* MAIN CONTAINER - MAXIMIZED WIDTH */}
//     <div className="max-w-[2000px] mx-auto px-6 sm:px-8 lg:px-12 py-8">
//       <div className="flex gap-8">
        
//         {/* Enhanced Sidebar Filters - FIXED WIDTH */}
//         <div className="w-80 flex-shrink-0">
//           <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl border border-gray-200/50 p-8 sticky top-6">
//             <div className="flex items-center justify-between mb-8">
//               <h3 className="text-2xl font-bold bg-gradient-to-r from-[#1f3c4a] to-[#2c5364] bg-clip-text text-transparent">Filters</h3>
//               {activeFiltersCount > 0 && (
//                 <span className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold bg-gradient-to-r from-teal-600 to-cyan-600 text-white shadow-lg ring-2 ring-teal-100">
//                   {activeFiltersCount}
//                 </span>
//               )}
//             </div>
...
//                   value={filters.search || ''}
//                   onChange={(e) => handleFilterChange('search', e.target.value)}
//                   className="w-full pl-12 pr-4 py-3.5 border-2 border-gray-200 rounded-2xl focus:outline-none focus:ring-3 focus:ring-teal-400/30 focus:border-teal-500 transition-all duration-300 text-sm bg-gray-50/50 hover:bg-white"
//                 />
...
//                 value={filters.category || ''}
//                 onChange={(e) => handleFilterChange('category', e.target.value)}
//                 className="w-full px-4 py-3.5 border-2 border-gray-200 rounded-2xl focus:outline-none focus:ring-3 focus:ring-teal-400/30 focus:border-teal-500 transition-all duration-300 text-sm bg-gray-50/50 hover:bg-white"
//               >
//                 <option value="">All Categories</option>
//                 {sampleCategories.map(category => (
//                   <option key={category.id} value={category.slug}>
...
//                   value={filters.minPrice || ''}
//                   onChange={(e) => handleFilterChange('minPrice', e.target.value ? parseFloat(e.target.value) : undefined)}
//                   className="px-4 py-3.5 border-2 border-gray-200 rounded-2xl focus:outline-none focus:ring-3 focus:ring-teal-400/30 focus:border-teal-500 transition-all duration-300 text-sm bg-gray-50/50 hover:bg-white"
//                 />
//                 <input
//                   type="number"
//                   placeholder="Max"
...
//             {activeFiltersCount > 0 && (
//               <div className="mb-6">
//                 <h4 className="text-sm font-bold text-gray-800 mb-3">Active Filters:</h4>
//                 <div className="flex flex-wrap gap-2">
//                   {filters.category && (
//                     <span className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-gradient-to-r from-teal-100 to-cyan-100 text-teal-800 border border-teal-200">
//                       {selectedCategory?.name}
//                       <button
//                         onClick={() => handleFilterChange('category', '')}
//                         className="ml-2 text-teal-600 hover:text-teal-800 transition-colors text-sm font-bold"
//                       >
//                         ×
//                       </button>
//                     </span>
//                   )}
//                   {filters.subcategory && (
//                     <span className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold bg-gradient-to-r from-cyan-100 to-blue-100 text-cyan-800 border border-cyan-200">
//                       {availableSubcategories.find(sub => sub.slug === filters.subcategory)?.name}
//                       <button
//                         onClick={() => handleFilterChange('subcategory', '')}
//                         className="ml-2 text-cyan-600 hover:text-cyan-800 transition-colors text-sm font-bold"
//                       >
//                         ×
//                       </button>
//                     </span>
...
//                       <button
//                         onClick={() => handleFilterChange('search', '')}
//                         className="ml-2 text-purple-600 hover:text-purple-800 transition-colors text-sm font-bold"
//                       >
//                         ×
//                       </button>
//                     </span>
...
//                       <button
//                         onClick={() => handleFilterChange('minPrice', undefined)}
//                         className="ml-2 text-yellow-600 hover:text-yellow-800 transition-colors text-sm font-bold"
//                       >
//                         ×
//                       </button>
//                     </span>
...
//             <button
//               onClick={clearAllFilters}
//               className="w-full bg-gradient-to-r from-[#1f3c4a] to-[#2c5364] hover:from-[#2a4a5a] hover:to-[#3a5a6a] text-white py-3.5 px-6 rounded-2xl font-bold transition-all duration-300 transform hover:scale-[1.02] shadow-xl hover:shadow-2xl text-sm"
//             >
//               Clear All Filters
//             </button>
//           </div>
...
//         {/* Main Content - MAXIMIZED WIDTH FOR 4 COLUMNS */}
//         <div className="flex-1">
//           {/* Sort and Results Count */}
//           <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 bg-white/95 backdrop-blur-lg rounded-3xl p-6 shadow-xl border border-gray-200/50">
//             <div className="mb-4 sm:mb-0">
...
//                 value={filters.sortBy || 'ending_soon'}
//                 onChange={(e) => handleFilterChange('sortBy', e.target.value)}
//                 className="px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-3 focus:ring-teal-400/30 focus:border-teal-500 transition-all duration-300 text-sm bg-gray-50/50 hover:bg-white"
//               >
//                 <option value="ending_soon">Ending Soon</option>
//                 <option value="newest">Newest First</option>
//                 <option value="price_low">Price: Low to High</option>
...
//           {/* Error Message */}
//           {error && (
//             <div className="bg-gradient-to-r from-red-50 to-red-100 border-2 border-red-200 rounded-3xl p-6 mb-8 shadow-lg">
//               <div className="flex">
//                 <svg className="w-6 h-6 text-red-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
//                   <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" />
//                 </svg>
...
//                 <div key={index} className="bg-white rounded-3xl shadow-xl overflow-hidden animate-pulse border border-gray-200/50">
...
//                     <div className="h-6 bg-gray-300 rounded-full w-full mb-3"></div>
...
//               </div>
//             ) : (
//               <div className="text-center py-20 bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl border border-gray-200/50">
...
//                   </svg>
//                 </div>
//                 <h3 className="text-3xl font-bold text-gray-900 mb-4">No auctions found</h3>
//                 <p className="text-gray-600 mb-8 max-w-md mx-auto text-lg">
//                   We couldn't find any auctions matching your criteria. Try adjusting your filters or search terms.
//                 </p>
//                 <button
//                   onClick={clearAllFilters}
//                   className="bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 text-white py-4 px-8 rounded-2xl font-bold transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl"
//                 >
//                   Clear All Filters
//                 </button>
//               </div>
...
//           {/* NEW: Page Navigation - Added between auction grid and load more button */}
//           {auctions.length > 0 && (
//             <div className="flex flex-col lg:flex-row items-center justify-between mt-10 mb-8 gap-6 bg-white/95 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-gray-200/50">
//               {/* Previous Button */}
//               <button
//                 onClick={() => {
//                   const newOffset = Math.max(0, pagination.offset - pagination.limit);
...
//                 }}
//                 disabled={pagination.offset === 0 || isLoading}
//                 className={`flex items-center px-6 py-3 text-sm font-bold rounded-2xl border-2 transition-all duration-300 ${
//                   pagination.offset === 0 || isLoading
//                     ? 'bg-gray-100 text-gray-400 border-gray-200 cursor-not-allowed'
//                     : 'bg-gradient-to-r from-teal-50 to-cyan-50 text-teal-700 border-teal-200 hover:from-teal-100 hover:to-cyan-100 hover:border-teal-300 transform hover:scale-105 shadow-lg'
//                 }`}
//               >
//                 <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
...
//                             dispatch(fetchAuctions(newFilters));
//                           }}
//                           className={`px-4 py-2.5 text-sm font-bold rounded-xl border-2 transition-all duration-300 ${
//                             i === currentPage
//                               ? 'bg-gradient-to-r from-teal-600 to-cyan-600 text-white border-teal-600 shadow-lg'
//                               : 'bg-white text-teal-700 border-teal-200 hover:bg-gradient-to-r hover:from-teal-50 hover:to-cyan-50 hover:border-teal-300 shadow-md hover:shadow-lg'
//                           }`}
//                         >
//                           {i}
//                         </button>
